...
if __name__ == "__main__":
    ...
    cat = skio.imread('cat.jpg')
    bread = skio.imread('bread.jpg')
    print(cat.shape, bread.shape)
    bread, cat = match_img_size(bread, cat)
    bread, cat = align_images(bread, cat)
    plt.imsave("cat_aligned.jpg", cat)
    plt.imsave("bread_aligned.jpg", bread)
